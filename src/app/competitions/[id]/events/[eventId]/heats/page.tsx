    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="flex flex-wrap items-end justify-between gap-3">
        ...
        {event.heats.length > 0 && (
          // The results page already makes the lane sheets, one page per
          // event, so this opens it with only those ticked.
          <Link
            href={`/competitions/${competition.id}/results?standings=0&events=0&teams=0&heats=1&format=print`}
            className="flex h-12 items-center gap-2 rounded-lg border border-line bg-card px-[18px] font-semibold"
          >
            <svg
              aria-hidden
              width="18"
